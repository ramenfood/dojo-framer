...
function MiningLandingPage(props: any) {
    ...
    return (
        <div
            ...
            style={{
                ...props.style, // 1. Inherit 1200px width from defaultProps (Fixes "0 Width" issue)
                maxWidth: "100%", // 2. Force shrink if parent is smaller than 1200px (Fixes Phone/Tablet overflow)
                backgroundColor: "#fff",
                display: "flex",
